      ...
      <header className="bg-[#061425] absolute top-0 left-0 right-0 z-50 sticky">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between max-h-[70px]">
          ...
          <nav className="hidden md:flex items-center space-x-8 h-full py-2">
            ...
            <button onClick={scrollToAboutUs} className={`text-[${colors.white}] hover:text-[${colors.red}] font-bold flex items-center h-full relative group ${pathname === '/about' ? `text-[${colors.red}]` : ''}`}>
              DESPRE NOI
            ...
            <button onClick={scrollToHowWeWork} className={`text-[${colors.white}] hover:text-[${colors.red}] font-bold flex items-center h-full relative group ${pathname === '/work' ? `text-[${colors.red}]` : ''}`}>
              CUM LUCRĂM
